 ...
 * @author Filip
 */
public class FormConfigBase extends javax.swing.JDialog {

    /**
     * Creates new form FormaKonfiguracijaBaza
     */
    public FormConfigBase(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Unesi podatke za konfig. baze:");
    ...
    private void jButtonSacuvajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSacuvajActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Parametri su sacuvani!", "SUCCESS", JOptionPane.INFORMATION_MESSAGE);
        }catch(Exception ex){
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "Parametri nisu sacuvani!", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
